...
export class OnboardComponent implements OnInit {
  ...
  public showSTHStateDropDown: boolean = false;
    ...
    this._httpService.submitAadharotp(data)
      .subscribe((result) => {
        if (result.status == 200) {
          ...
          mixpanel.track('contract-tab-save-proceeded', data);
          Intercom('trackEvent', 'contract-tab-save-proceeded', data);
          this.getMobData();
        }
      },
      (err: any) => {
  ...
  getMobData() {
    ...
    this._httpService.getMobDetails()
      .subscribe((result) => {
        ...
        if (typeof this.mob_data != "undefined" && typeof this.mob_data.mob_business_types_id != "undefined" && this.mob_data.mob_business_types_id != 1) {
            ...
            result.meta.forEach(e => {
              if (e.hasOwnProperty('intercom')) {
                ...
                window.intercomSettings = {
                  ...
                  pan_no: result.data.mob_business_details.data.individual_pan_details.data.individual_pan_number,
